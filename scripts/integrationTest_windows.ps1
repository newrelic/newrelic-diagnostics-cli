...
go test integration/integration_test.go integration/integration_test_timer.go integration/dockerHelper_test.go -v -timeout 3h --tags=integration -testNames="$tests"
