...
$env:GOARCH='386'
go build -o $EXENAME -ldflags "-X github.com/newrelic/newrelic-diagnostics-cli/config.Version=INTEGRATION -X github.com/newrelic/newrelic-diagnostics-cli/config.BuildTimestamp=$BUILD_TIMESTAMP"
