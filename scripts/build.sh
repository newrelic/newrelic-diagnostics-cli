...
if [ -z "$BUILD_NUMBER" ]; then
  ...
  JP_USAGE_ENDPOINT="${STAGING_USAGE_ENDPOINT}"
  JP_ATTACHMENT_ENDPOINT="${STAGING_ATTACHMENT_ENDPOINT}"
  JP_HABERDASHER_URL="${STAGING_HABERDASHER_URL}"
else
